...
const ARTIFACTS = [
  ...
  {
    key: 'data-index',
    title: 'Data API · index.json',
    copy: 'Structured-data entry point for AI agents. One manifest pointing at every run, branch, day, comparison, snapshot, event, and decision (ADR-040).',
    href: '/yy/data/index.json',
    external: true,
  },
  {
    key: 'llms-txt',
    title: 'llms.txt',
    copy: 'Prose entry point for models and tooling. Canonical list of pages and artifacts.',
    href: '/llms.txt',
    external: true,
  },
]
